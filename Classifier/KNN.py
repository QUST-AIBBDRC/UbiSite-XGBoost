...
cv_clf = KNeighborsClassifier(n_neighbors=5,weights="uniform",algorithm="auto")#KNN
...
yscore_sum.to_csv('yscore_sum_KNN_lassoset1A1_feature0.005.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_KNN_lassoset1A1_feature0.005.csv')
...
data_csv.to_csv('KNN_lassoset1A1_feature0.005.csv')
