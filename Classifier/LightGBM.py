...
yscore_sum.to_csv('yscore_sum_LightGBM_lassoset1A1_feature0.005.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_LightGBM_lassoset1A1_feature0.005.csv')
...
data_csv.to_csv('LightGBM_lassoset1A1_feature0.005.csv')
